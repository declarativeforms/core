...
export interface IConnectionStrategy {
  ...
  handle(connection: any, submission: ISubmission, form: IDeclarativeForm): Promise<void>;
}

export interface IValidationStrategy {
  validate(form: IDeclarativeForm, data: Record<string, unknown>, metadata?: { ip?: string; isPartial?: boolean }): Promise<string | null>;
}
