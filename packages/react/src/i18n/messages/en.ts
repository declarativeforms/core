const enMessageSource = {
  ...
  'email.placeholder_otp': 'name@example.com',
  'email.otp.enter_code': 'Enter the verification code.',
  'email.otp.invalid_code': 'Invalid or expired verification code.',
  ...
  'email.otp.request_failed': 'Unable to complete the request.',
  'email.otp.send_failed': 'Unable to send the verification code.',
  'email.otp.start_failed': 'Unable to start email verification.',
  'email.otp.token_missing': 'Verification succeeded but no token was returned.',
  'email.otp.resend_in_seconds': 'Resend in {{seconds}}s',
  'email.otp.resend': 'Resend',
  'email.otp.send_code': 'Send code',
  'email.otp.verification_code_placeholder': 'Verification code',
  'email.otp.verification_code_aria_label': 'Verification code',
  'email.otp.verify': 'Verify code',
  ...
  'validation.email_otp_required': 'Verify this email address to continue.',
