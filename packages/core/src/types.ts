import type { DeclarativeFieldType } from './definition';
...
export type FieldView = CompiledField;
export type SectionView = CompiledSection;
export type CompletionView = CompiledCompletion;
