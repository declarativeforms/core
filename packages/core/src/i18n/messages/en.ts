const enMessageSource = {
  ...
  'turnstile.unavailable': 'Verification is currently unavailable.',
  'turnstile.success': 'Verification complete.',
  'turnstile.retry': 'Verify again',
  'email.verification_send': 'Send code',
  'email.verification_sending': 'Sending...',
  'email.verification_resend': 'Resend code',
  'email.verification_resend_in': 'Resend in {{seconds}}s',
  'email.verification_code_placeholder': '6-digit code',
  'email.verification_code_sent': 'Check your email for the verification code.',
  'email.verification_verify': 'Verify',
  'email.verification_verifying': 'Verifying...',
  'email.verification_success': 'Email address verified.',
  'email.verification_change': 'Change',
  'email.verification_request_failed': 'Could not send a verification code.',
