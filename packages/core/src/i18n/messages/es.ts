...
export const esMessages: TranslationMessages = {
  ...
  'turnstile.failed': 'La verificación falló. Inténtalo de nuevo.',
  'turnstile.unavailable':
    'La verificación no está disponible en este momento.',
  'turnstile.success': 'Verificación completada.',
  'turnstile.retry': 'Verificar de nuevo',
