...
export type FormDefinition = IDeclarativeForm;
export type FormSectionDefinition = IDeclarativeFormSection;
export type FormFieldDefinition = IDeclarativeFormField;
