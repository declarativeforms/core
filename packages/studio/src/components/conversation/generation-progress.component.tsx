    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col items-start gap-1">
        <div className="flex max-w-[46rem] items-center gap-2 rounded-lg bg-muted px-3 py-2 text-sm">
          ...
          <span aria-live="polite">Working on your request… {elapsed}s</span>
        </div>
        <p className="px-1 text-xs text-muted-foreground">
          This usually takes 20 to 60 seconds. Requested changes take effect
          automatically when ready. Questions and advice leave the form
          unchanged.
