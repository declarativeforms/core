...
export function FormBuilder({ form, onChange }: FormBuilderProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden rounded-xl border border-border bg-background md:flex-row">
      <div className="flex min-h-0 max-h-[40%] w-full shrink-0 flex-col overflow-hidden border-b border-border bg-muted/10 md:max-h-none md:w-72 md:border-b-0 md:border-r">
