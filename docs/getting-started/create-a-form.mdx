...
<Tip>
**Want to experiment first?** Open the [playground](https://frms.dev/playground) to write YAML and preview your form in the browser — no repository required. See [Test a form in the playground](/examples/test-a-form-in-the-playground) for details.
</Tip>

<Tip>
**Prefer to use an AI coding agent?** Fork the [starter repository](https://github.com/declarativeforms/declarativeforms), describe the form you need in plain language, and let the agent generate the YAML for you. See [Use the starter repository](/getting-started/use-the-starter-repository) for details.
</Tip>
